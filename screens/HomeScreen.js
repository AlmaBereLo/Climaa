...
export default function HomeScreen() {
    ...
    const navigateToDetails = (screenName) => {
                ...
                <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
                    ...
                    <View className="mx-4 flex justify-around flex-1 mb-2">
                        ...
                        <View className="flex-row justify-between mx-4">
                            ...
                            <View className="flex-row space-x-2 items-center">
                                ...
                                />
                                <Text className="text-white font-semibold text-base">
                                    {/* Aquí falta el dato del sol, agrégalo si es necesario */}
                                </Text>
                            </View>
                        </View>
                    </View>
                    ...
                    <View className="mb-2 space-y-3">
                        ...
                        >
                            ...
                            >
                                <Image
                                    source={require('../assets/images/mas_ (1).png')}
                                    className="w-11 h-11"
                                />
                                <TouchableOpacity onPress={() => navigateToDetails('NoExponerse')}>
                                    <Text style={{ color: 'white', marginTop: 5 }}>Ver más</Text>
                                </TouchableOpacity>
                            </View>
                        </ScrollView>
                        ...
                        >
                            <View
                                className="flex justify-center items-center rounded-3xl py-3 space-y-3 mr-4"
                                style={{ backgroundColor: 'rgba(0, 122, 255, 0.2)', width: 100 }} // Azul translúcido
                            >
                                <Image
                                ...
                                <Text className="text-white text-xl font-semibold text-center">Protector Solar</Text>
                            </View>
                            ...
                            >
                                <Image
                                    ...
                                    className="w-11 h-11"
                                />
                                <Text className="text-white text-xl font-semibold text-center">Balsamo de labios</Text>
                            </View>
                            ...
                            >
                                <Image
                                    ...
                                    className="w-11 h-11"
                                />
                                <Text className="text-white font-semibold text-center">Despigmentante</Text>
                            </View>
